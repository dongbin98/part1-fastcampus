...
//        val secondNumber = firstNumberText.toString().toInt()
    ...
    fun operatorClicked(view: View) {
        ...
        if(firstNumberText.isEmpty()) {
            Toast.makeText(this, "숫자 먼저 입력", Toast.LENGTH_SHORT).show()
            return
        }
        if(secondNumberText.isNotEmpty()) {
            Toast.makeText(this, "1개의 연산자만 가능", Toast.LENGTH_SHORT).show()
            return
        }
